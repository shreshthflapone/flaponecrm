...
const AllStudents = ({
  ...
  handleCellClick
        ...
        useTitle("All Studnets - Flapone Aviation");
        ...
        <table className="mylead-table cp wsnw">
          <thead className="w100">
            <tr>
              ...
              <th onClick={() => handleSortByChange("prefered_batch")} className={activeSortColumn === "prefered_batch" ? "fc1" : ""}>
                <p className="box-center">
                  <DynamicTooltip direction="bottom" text="Prefered Batch/Date">Prefered <br/>Batch</DynamicTooltip>
                  <RiArrowUpDownFill className="cp ml4" />
                </p>
              </th>
                            ...
                            : student.course_status_student === "Batch Running"
                              ...
                              : student.course_status_student === "Dropped"
                                ...
                                : student.course_status_student === "Batch Allotted"
                                  ...
                                  ? "darkgreen"
				  : student.course_status_student === "Invite"
                                  ? "yellow"
