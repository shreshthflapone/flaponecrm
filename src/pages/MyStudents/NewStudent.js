...
const AllStudents = ({
  ...
  handleCellClick
        ...
        useTitle("New Students - Flapone Aviation");
          ...
          <thead className="w100">
            <tr>
              ...
              <th onClick={() => handleSortByChange("preferred_batch")} className={activeSortColumn === "preferred_batch" ? "fc1" : ""}>
                <p className="box-center">
                <DynamicTooltip direction="bottom" text="Preferred Batch/Date">Preferred <br/>Batch</DynamicTooltip>
                  <RiArrowUpDownFill className="cp ml4" />
                </p>
              </th>
              ...
              <th onClick={() => handleSortByChange("booking_date_long")} className={activeSortColumn === "booking_date_long" ? "fc1" : ""}>
                <p className="box-center">
                  Booking Date
                  <RiArrowUpDownFill className="cp ml4" />
                </p>
