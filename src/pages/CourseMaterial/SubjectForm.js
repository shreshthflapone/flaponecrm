...
import PositionImageUpload from "../../components/PositionImageUpload.js";
...
/*	
  ...
  */
	...
	const handleUploadImageVideo = useCallback(
    (id, content, mediaType, index) => {
      setSubjectFormData((prevValues) => {
        const updatedMaterials = [...prevValues.courseMaterials];
        if (mediaType === "image") {
          updatedMaterials[index].images = content;
        } else if (mediaType === "video") {
          updatedMaterials[index].videos = content;
      ...
      setSubjectFormDataPreview((prevValues) => {
        const updatedMaterials = [...prevValues.topics];
        if (mediaType === "image") {
          updatedMaterials[index].images = content;
        } else if (mediaType === "video") {
          updatedMaterials[index].videos = content;
  ...
  return (
    <>
      ...
      <Card className="card bg5 mt16 pl8 pr8 pt20 pb10 ">
          ...
          if (material.status !== "0") {
            ...
            return (
              <>  
                ...
                >
                  <div className="v-center jcsb course-topic">
                    ...
                    <div className="form-group-settings batch-name flx1 v-center ml16 course-dur-top">
        ...
        <div className="form-group-settings course-name flx100  bg8 pl20 pr20 pt20 pb20 mt16" style={{ marginBottom: '100px' }}>
          <SingleDropdown
            label="Show After"
        ...
        <div className="radio-grp-status box-center fww mt12 ">
