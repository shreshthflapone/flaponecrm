...
const NewLeads = ({
  ...
  user,
          ...
          useTitle("New Lead - Flapone Aviation");
  ...
  const handleAssignToClick = () => {
    if (assigned.value) {
      const updatedLeads = allLeadData.map((lead) => {
  ...
  const handleHeaderCheckboxChange = (event) => {
    const allLeadIds = allLeadData.map((lead) => lead.userid);
    setSelectedLeads(event.target.checked ? allLeadIds : []);
  };

  const isHeaderCheckboxChecked =
    selectedLeads.length === allLeadData.length && selectedLeads.length > 0;
    ...
    <>
      ...
      >
        <table className="mylead-table cp wsnw">
          <thead className="w100">
            <tr>
              ...
              {/* <th onClick={() => handleSortByChange("user_type")} className={activeSortColumn === "user_type" ? "fc1" : ""}>
                <p className="box-center">
                  Type
                  <RiArrowUpDownFill className="cp ml4" />
                </p>
              ...
              <th
                onClick={() =>
                  handleSortByChange("last_status_update_date_long")
                }
                className={
                  activeSortColumn === "last_status_update_date_long"
                    ? "fc1"
                    : ""
                }
              >
              ...
              <th
                ...
                className={
                  activeSortColumn === "last_followup_long" ? "fc1" : ""
                }
                style={{ width: 90 }}
              >
                <p className="box-center">
              ...
              return (
                <tr key={index} onClick={() => handleRowClick(lead.userid)}>
                          ...
                          : lead.last_lead_status === "Booked"
                            ...
                            : lead.last_lead_status === "Hot"
                              ...
                              : lead.last_lead_status === "Follow-Up" ||
                                  lead.last_lead_status === "Interested"
                                ? "News"
                  ...
                  <td className="lead-tools-fix">
                    <span
                      className={`ls1 ${lead.email_status > 0 || lead.mobile_status > 0 ? "fc2" : "fc5"} box-center`}
                    >
                      {lead.email_status > 0 || lead.mobile_status > 0 ? (
                        <>
                          {lead.email_status > 0 && (
        ...
        {selectedLeads.length > 0 && (
          <div className="v-center fixed-buttons-mylead">
            <button
              type="button"
